...
exports.createPaymentSession = async (req, res) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
        success_url: `${process.env.VITE_APP_URL || 'https://dromcws.vercel.app'}/payment-success?billing_id=${billingId}`,
        cancel_url: `${process.env.VITE_APP_URL || 'https://dromcws.vercel.app'}/payment-canceled`,
      metadata: {
